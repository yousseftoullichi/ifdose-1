...
@section('adminlte_css')
    <link rel="stylesheet"
          href="{{ asset('vendor/adminlte/dist/css/skins/skin-' . config('adminlte.skin', 'blue-light') . '.css')}} ">
    @stack('css')
    @yield('css')
@stop

@section('body_class', 'skin-' . config('adminlte.skin', 'blue-light') . ' sidebar-mini ' . (config('adminlte.layout') ? [
    'boxed' => 'layout-boxed',
    'fixed' => 'fixed',
...
@section('body')
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            @if(config('adminlte.layout') == 'layout-top-nav')
                <nav class="navbar navbar-static-top">
                    <div class="container">
                        <div class="navbar-header">
                            <a href="{{ url(config('adminlte.dashboard_url', 'home')) }}" class="navbar-brand">
                                <img  src="{{ asset('vendor/logo2.png') }}" >
                            </a>
                    ...
                    @else
                        <!-- Logo -->
                            <a href="{{ url(config('adminlte.dashboard_url', 'home')) }}" class="logo">
                                ...
                                <span class="logo-lg"> <img  src="{{ asset('vendor/logo.png') }}" ></span>
                            </a>
                            ...
                            <!-- Navbar Right Menu -->
                                <div class="navbar-custom-menu">
                                    ...
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li><a href="/profile" id="profile" class="profile">Profile</a>
                                        </li>
                                        <li>
    ...
    <div class="col-md-4">      
        <div class="portlet light profile-sidebar-portlet bordered">
            <div class="profile-userpic">
                ...
                <img src="{{$pathImage}}" class="img-responsive" alt="">
            ...
            <div class="profile-usertitle">
                <div class="profile-usertitle-name"> Medecin </div>
            ...
            <div class="portlet-body">
                <div>
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#prof" aria-controls="profile" role="tab" data-toggle="tab">Profile</a></li>
...
<!-- Modal -->
<div class="modal fade" id="home" tabindex="-1"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div  class="modal-dialog"  >
        <div class="modal-content"  >
            ...
            <div class="modal-body" bgcolor="red" >
                            <form enctype="multipart/form-data"  action="{{ route('postMed') }}" method="POST"> 
                                {{ csrf_field()}}
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="tel" id="exampleInputEmail1" placeholder="Telephone">
                              </div>
                              <div class="form-group">
                                <label for="exampleInputPassword1">Addresse</label>
                                <input type="text" class="form-control" name="adr" id="exampleInputPassword1" placeholder="Addresse">
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <input type="file"  id="exampleInputFile" name="medimage">-->
                                <div class="input-group">
                <label class="input-group-btn">
                    <span class="btn btn-primary">
                        Browse <input type="file" name="medimage" style="display: none;" multiple>
                    </span>
                </label>
                <input type="text" class="form-control" readonly>
                         ...
                         <div role="tabpanel" class="tab-pane active" id="prof">
                            ...
                            @if($medecin !=null)
                              ...
                              <div class="form-group">
                                <label for="inputName">Prénom</label>
                                <input type="text" class="form-control"  name ="prenom"id="inputName" placeholder="Prenom" value="{{$medecin->prenom}}" disabled="disabled">
                              </div>
                                <div class="form-group">
                                <label for="inputLastName">Nom</label>
                                <input type="text" class="form-control" name="nom" id="inputLastName" placeholder="Nom" value="{{$medecin->nom}}" disabled="disabled">
                              </div>
                              <div class="form-group">
                                <label for="exampleInputEmail1">Telephone</label>
                                <input type="text" class="form-control" name="tel" id="exampleInputEmail1" placeholder="Telephone" value="{{$medecin->telephone}}" disabled="disabled">
                              </div>
                              <div class="form-group">
                                <label for="exampleInputPassword1">Addresse</label>
                                <input type="text" class="form-control" name="adr" id="exampleInputPassword1" placeholder="Addresse" value="{{$medecin->adresse}}" disabled="disabled">
                              </div>
                              <div class="form-group">
                                <label for="exampleInputPassword1">ville</label>
                                <input type="text" class="form-control" name="ville" id="exampleInputPassword1" placeholder="ville" value="{{$medecin->ville}}" disabled="disabled">
                              </div>
                            ...
                            @endif
                            <button type="button" id="register" class="btn btn-success" >Mise à jour</button>
